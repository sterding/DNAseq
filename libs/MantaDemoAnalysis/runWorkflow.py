#!/usr/bin/env python2
# Workflow run script auto-generated by command: '/PHShome/xd010/bin/configManta.py --normalBam=/PHShome/xd010/share/demo/manta/data/HCC1954.NORMAL.30x.compare.COST16011_region.bam --tumorBam=/PHShome/xd010/share/demo/manta/data/G15512.HCC1954.1.COST16011_region.bam --referenceFasta=/PHShome/xd010/share/demo/manta/data/Homo_sapiens_assembly19.COST16011_region.fa --region=8:107652000-107655000 --region=11:94974000-94989000 --candidateBins=4 --exome --runDir=MantaDemoAnalysis'
#
...
sys.path.append(r'/PHShome/xd010/lib/python')
...
main(r"/data/neurogen/pipeline/DNAseq/libs/MantaDemoAnalysis/runWorkflow.py.config.pickle","manta",MantaWorkflow)
